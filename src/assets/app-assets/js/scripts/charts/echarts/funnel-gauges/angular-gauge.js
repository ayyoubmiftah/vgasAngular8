/*=========================================================================================
    File Name: intervention-management-frontend-gauge.js
    Description: echarts intervention-management-frontend gauge chart
==========================================================================================*/
...
$(window).on("load", function(){
    ...
    require(
        ...
        function (ec) {
            ...
            // Initialize chart
            // ------------------------------
            var myChart = ec.init(document.getElementById('intervention-management-frontend-gauge'));

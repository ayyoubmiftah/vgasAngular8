...
function RatingComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtextInterpolate(index_r21 < value_r20 ? "\u2605" : "\u2606");
} }
...
function RatingComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mouseenter", function RatingComponent_ng_template_3_Template_span_mouseenter_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r26); const index_r23 = ctx.index; const ctx_r25 = ɵngcc0.ɵɵnextContext(); return ctx_r25.enter(index_r23 + 1); });
    ɵngcc0.ɵɵlistener("click", function RatingComponent_ng_template_3_Template_span_click_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r26); const index_r23 = ctx.index; const ctx_r27 = ɵngcc0.ɵɵnextContext(); return ctx_r27.rate(index_r23 + 1); });
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1("(", index_r23 < ctx_r19.value ? "*" : " ", ")");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵstyleProp("cursor", ctx_r19.readonly ? "default" : "pointer");
    ɵngcc0.ɵɵclassProp("active", index_r23 < ctx_r19.value);
    ɵngcc0.ɵɵproperty("title", r_r22.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r19.customTemplate || _r17)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(6, _c0, index_r23, ctx_r19.value));
} }
...
RatingComponent.ɵfac = function RatingComponent_Factory(t) { return new (t || RatingComponent)(ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef)); };
RatingComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: RatingComponent, selectors: [["rating"]], hostBindings: function RatingComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(3, RatingComponent_ng_template_3_Template, 4, 9, "ng-template", 2);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {

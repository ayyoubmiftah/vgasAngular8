...
function ProgressbarComponent_bar_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("type", ctx_r16.type)("value", ctx_r16._value);
} }
function ProgressbarComponent_ng_template_1_bar_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("type", item_r19.type)("value", item_r19.value);
    ɵngcc0.ɵɵadvance(1);
...
function ProgressbarComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r17._value);
} }
const _c0 = ["*"];
...
ProgressbarConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ProgressbarConfig, factory: function (t) { return ProgressbarConfig.ɵfac(t); }, providedIn: null });
...
ProgressbarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ProgressbarComponent, selectors: [["progressbar"]], hostBindings: function ProgressbarComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
BarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: BarComponent, selectors: [["bar"]], hostBindings: function BarComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {

...
function PopoverContainerComponent_h3_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r238.title);
} }
const _c1 = ["*"];
class PopoverConfig {
    constructor() {
...
PopoverConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PopoverConfig, factory: function (t) { return PopoverConfig.ɵfac(t); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopoverConfig, [{
        type: Injectable
    }], function () { return []; }, { constructor: [], adaptivePosition: [], placement: [], triggers: [], outsideClick: [] });
...
PopoverContainerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PopoverContainerComponent, selectors: [["popover-container"]], hostBindings: function PopoverContainerComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
    ...
    } }, inputs: { placement: "placement", title: "title" }, ngContentSelectors: _c1, decls: 4, vars: 1, consts: [[1, "popover-arrow", "arrow"], ["class", "popover-title popover-header", 4, "ngIf"], [1, "popover-content", "popover-body"], [1, "popover-title", "popover-header"]], template: function PopoverContainerComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopoverContainerComponent, [{
    ...
    }], function () { return [{ type: PopoverConfig }]; }, { constructor: [], isBs3: [], placement: [{
            type: Input
        }], title: [{
            type: Input
        }] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PopoverDirective, [{
    ...
    }], function () { return [{ type: PopoverConfig }, { type: ElementRef }, { type: Renderer2 }, { type: ViewContainerRef }, { type: ComponentLoaderFactory }, { type: PositioningService }]; }, { constructor: [], _positionService: [], outsideClick: [{
            type: Input
        }], containerClass: [{
            type: Input

...
TooltipConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: TooltipConfig, factory: function (t) { return TooltipConfig.ɵfac(t); }, providedIn: null });
...
TooltipContainerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TooltipContainerComponent, selectors: [["bs-tooltip-container"]], hostBindings: function TooltipContainerComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
    ...
    } }, ngContentSelectors: _c1, decls: 3, vars: 0, consts: [[1, "tooltip-arrow", "arrow"], [1, "tooltip-inner"]], template: function TooltipContainerComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(TooltipContainerComponent, [{
  ...
  `]
    ...
    }], function () { return [{ type: TooltipConfig }]; }, { constructor: [], isBs3: [], ngAfterViewInit: [], classMap: [] });
...
TooltipDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TooltipDirective, selectors: [["", "tooltip", ""], ["", "tooltipHtml", ""]], hostBindings: function TooltipDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(TooltipModule, { declarations: function () { return [TooltipDirective,

...
export declare class RatingComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<RatingComponent, "rating", never, { 'max': "max", 'titles': "titles", 'readonly': "readonly", 'customTemplate': "customTemplate" }, { 'onHover': "onHover", 'onLeave': "onLeave" }, never>;
}

...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ThemeService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return []; }, { constructor: [], pColorschemesOptions: [], colorschemesOptions: [], setColorschemesOptions: [], getColorschemesOptions: [] });
...
BaseChartDirective.ɵfac = function BaseChartDirective_Factory(t) { return new (t || BaseChartDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(ThemeService)); };
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BaseChartDirective, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ElementRef }, { type: ThemeService }]; }, { constructor: [], element: [], themeService: [], options: [{
            type: Input
        }], chartClick: [{
            type: Output
        }], chartHover: [{
            type: Output
        }], old: [], subs: [], ngOnInit: [], ctx: [], themeChanged: [], ngDoCheck: [], copyLabel: [], labelsEqual: [], copyColor: [], colorsEqual: [], updateColors: [], ngOnChanges: [], ngOnDestroy: [], chart: [], update: [], hideDataset: [], isDatasetHidden: [], toBase64Image: [], getChartConfiguration: [], getChartBuilder: [], smartMerge: [], isMultiLineLabel: [], joinLabel: [], propagateDatasetsToData: [], data: [{
            type: Input
        }], propagateDataToDatasets: [], datasets: [{
            type: Input
        }], isMultiDataSet: [], getDatasets: [], refresh: [], labels: [{
            type: Input
        }], chartType: [{
            type: Input
        }], colors: [{
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ChartsModule, { declarations: [BaseChartDirective], exports: [BaseChartDirective] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ChartsModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    BaseChartDirective

...
function Toast_button_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Toast_button_0_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r5 = ɵngcc0.ɵɵnextContext(); return ctx_r5.remove(); });
...
function ToastNoAnimation_button_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelementStart(0, "button", 5);
    ɵngcc0.ɵɵlistener("click", function ToastNoAnimation_button_0_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r14); const ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.remove(); });
    ɵngcc0.ɵɵelementStart(1, "span", 6);
    ɵngcc0.ɵɵtext(2, "\u00D7");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
...
ToastContainerDirective.ɵfac = function ToastContainerDirective_Factory(t) { return new (t || ToastContainerDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef)); };
...
Overlay.ɵfac = function Overlay_Factory(t) { return new (t || Overlay)(ɵngcc0.ɵɵinject(OverlayContainer), ɵngcc0.ɵɵinject(ComponentFactoryResolver), ɵngcc0.ɵɵinject(ApplicationRef), ɵngcc0.ɵɵinject(DOCUMENT)); };
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Overlay, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: OverlayContainer }, { type: ComponentFactoryResolver }, { type: ApplicationRef }, { type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { constructor: [], _overlayContainer: [], _componentFactoryResolver: [], _appRef: [], _document: [], _paneElements: [], create: [], getPaneElement: [], _createPaneElement: [], _createPortalHost: [], _createOverlayRef: [] });
...
ToastrService.ɵfac = function ToastrService_Factory(t) { return new (t || ToastrService)(ɵngcc0.ɵɵinject(TOAST_CONFIG), ɵngcc0.ɵɵinject(Overlay), ɵngcc0.ɵɵinject(Injector), ɵngcc0.ɵɵinject(DomSanitizer), ɵngcc0.ɵɵinject(NgZone)); };
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ToastrService, [{
        ...
        args: [{ providedIn: 'root' }]
                ...
                type: Inject,
                args: [TOAST_CONFIG]
            }] }, { type: Overlay }, { type: Injector }, { type: DomSanitizer }, { type: NgZone }]; }, { constructor: [], overlay: [], _injector: [], sanitizer: [], ngZone: [], currentlyActive: [], toasts: [], index: [], toastrConfig: [], show: [], success: [], error: [], info: [], warning: [], clear: [], remove: [], findDuplicate: [], applyConfig: [], _findToast: [], _preBuildNotification: [], _buildNotification: [], previousToastMessage: [] });
...
Toast.ɵfac = function Toast_Factory(t) { return new (t || Toast)(ɵngcc0.ɵɵdirectiveInject(ToastrService), ɵngcc0.ɵɵdirectiveInject(ToastPackage), ɵngcc0.ɵɵdirectiveInject(NgZone)); };
Toast.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Toast, selectors: [["", "toast-component", ""]], hostBindings: function Toast_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ɵngcc0.ɵɵallocHostVars(4);
        ɵngcc0.ɵɵlistener("click", function Toast_click_HostBindingHandler($event) { return ctx.tapToast(); });
        ɵngcc0.ɵɵlistener("mouseenter", function Toast_mouseenter_HostBindingHandler($event) { return ctx.stickAround(); });
        ɵngcc0.ɵɵlistener("mouseleave", function Toast_mouseleave_HostBindingHandler($event) { return ctx.delayedHideToast(); });
    } if (rf & 2) {
        ...
        ɵngcc0.ɵɵtemplate(4, Toast_div_4_Template, 2, 1, "div", 4);
    } if (rf & 2) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Toast, [{
        type: Component,
        args: [{
  ...
  `,
    ...
    }], function () { return [{ type: ToastrService }, { type: ToastPackage }, { type: NgZone }]; }, { constructor: [], toastrService: [], toastPackage: [], ngZone: [], width: [], toastClasses: [{
            type: HostBinding,
            args: ['class']
        }], state: [{
            type: HostBinding,
            args: ['@flyInOut']
        }], message: [], title: [], options: [], originalTimeout: [], sub: [], sub1: [], sub2: [], sub3: [], duplicatesCount: [], displayStyle: [{
            type: HostBinding,
            args: ['style.display']
        }], ngOnDestroy: [], activateToast: [], hideTime: [], updateProgress: [], resetTimeout: [], remove: [], tapToast: [{
            type: HostListener,
            args: ['click']
        }], stickAround: [{
            type: HostListener,
            ...
            type: HostListener,
            args: ['mouseleave']
        }], outsideTimeout: [], timeout: [], outsideInterval: [], intervalId: [], runInsideAngular: [] });
__decorate([
    HostBinding('class'),
...
ToastNoAnimation.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ToastNoAnimation, selectors: [["", "toast-component", ""]], hostBindings: function ToastNoAnimation_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(4, ToastNoAnimation_div_4_Template, 2, 1, "div", 4);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ctx.options.closeButton);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx.title);

...
function NgxUiLoaderComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("height", ctx_r0.pbThickness, "px");
    ɵngcc0.ɵɵstyleProp("color", ctx_r0.pbColor);
    ɵngcc0.ɵɵclassProp("ngx-position-absolute", ctx_r0.loaderId !== ctx_r0.defaultConfig.masterLoaderId);
    ɵngcc0.ɵɵclassProp("loading-foreground", ctx_r0.showForeground);
    ɵngcc0.ɵɵclassProp("foreground-closing", ctx_r0.foregroundClosing);
...
function NgxUiLoaderComponent_img_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("width", ctx_r1.logoSize, "px");
    ɵngcc0.ɵɵstyleProp("height", ctx_r1.logoSize, "px");
    ɵngcc0.ɵɵstyleProp("top", ctx_r1.logoTop);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r1.logoPosition)("src", ctx_r1.trustedLogoUrl, ɵngcc0.ɵɵsanitizeUrl);
} }
function NgxUiLoaderComponent_div_5_Template(rf, ctx) { if (rf & 1) {
...
NgxUiLoaderService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgxUiLoaderService, factory: function (t) { return NgxUiLoaderService.ɵfac(t); }, providedIn: 'root' });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
            ...
            }] }]; }, { constructor: [], config: [], defaultConfig: [], loaders: [], showForeground: [], showForeground$: [], showBackground: [], showBackground$: [], fgClosing: [], foregroundClosing$: [], bgClosing: [], backgroundClosing$: [], bindLoaderData: [], updateLoaderId: [], destroyLoaderData: [], getDefaultConfig: [], getLoaders: [], getLoader: [], startLoader: [], start: [], startBackgroundLoader: [], startBackground: [], stopLoader: [], stop: [], stopBackgroundLoader: [], stopBackground: [], stopAllLoader: [], stopAll: [], createLoaderData: [], throwErrorIfLoaderNotExist: [], throwErrorIfLoaderExists: [], throwErrorIfMasterLoaderExists: [], throwErrorIfMasterLoaderNotExist: [], foregroundCloseout: [], backgroundCloseout: [], clearTimers: [], clearAllTimers: [], hasRunningTask: [], readyToStart: [], readyToStop: [], setDelayTimer: [], setMaxTimer: [], setMinTimer: [] });
...
NgxUiLoaderComponent.ɵfac = function NgxUiLoaderComponent_Factory(t) { return new (t || NgxUiLoaderComponent)(ɵngcc0.ɵɵdirectiveInject(DomSanitizer), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(NgxUiLoaderService)); };
NgxUiLoaderComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxUiLoaderComponent, selectors: [["ngx-ui-loader"]], inputs: { bgsColor: "bgsColor", bgsOpacity: "bgsOpacity", bgsPosition: "bgsPosition", bgsSize: "bgsSize", bgsType: "bgsType", fgsColor: "fgsColor", fgsPosition: "fgsPosition", fgsSize: "fgsSize", fgsType: "fgsType", gap: "gap", loaderId: "loaderId", logoPosition: "logoPosition", logoSize: "logoSize", logoUrl: "logoUrl", overlayBorderRadius: "overlayBorderRadius", overlayColor: "overlayColor", pbColor: "pbColor", pbDirection: "pbDirection", pbThickness: "pbThickness", hasProgressBar: "hasProgressBar", text: "text", textColor: "textColor", textPosition: "textPosition" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], decls: 11, vars: 30, consts: [["class", "ngx-progress-bar", 3, "ngx-position-absolute", "ngClass", "height", "color", "loading-foreground", "foreground-closing", 4, "ngIf"], [1, "ngx-overlay"], ["class", "ngx-loading-logo", 3, "ngClass", "src", "width", "height", "top", 4, "ngIf"], [1, "ngx-foreground-spinner", 3, "ngClass"], [4, "ngFor", "ngForOf"], [1, "ngx-loading-text", 3, "ngClass"], [1, "ngx-background-spinner", 3, "ngClass"], [1, "ngx-progress-bar", 3, "ngClass"], [1, "ngx-loading-logo", 3, "ngClass", "src"]], template: function NgxUiLoaderComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, NgxUiLoaderComponent_div_0_Template, 1, 6, "div", 0);
        ɵngcc0.ɵɵelementStart(1, "div", 1);
        ɵngcc0.ɵɵtemplate(2, NgxUiLoaderComponent_img_2_Template, 1, 5, "img", 2);
        ɵngcc0.ɵɵelementStart(3, "div", 3);
        ɵngcc0.ɵɵelementStart(4, "div");
        ɵngcc0.ɵɵtemplate(5, NgxUiLoaderComponent_div_5_Template, 1, 0, "div", 4);
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: DomSanitizer }, { type: ChangeDetectorRef }, { type: NgxUiLoaderService }]; }, { constructor: [], domSanitizer: [], changeDetectorRef: [], ngxService: [], initialized: [], defaultConfig: [], bgsColor: [{
            type: Input
        }], bgsOpacity: [{
            type: Input
        }], bgsPosition: [{
            ...
            type: Input
        }], ngOnInit: [], trustedLogoUrl: [], showForegroundWatcher: [], showForeground: [], showBackgroundWatcher: [], showBackground: [], foregroundClosingWatcher: [], foregroundClosing: [], backgroundClosingWatcher: [], backgroundClosing: [], ngOnChanges: [], initializeSpinners: [], fgDivs: [], fgSpinnerClass: [], bgDivs: [], bgSpinnerClass: [], determinePositions: [], logoTop: [], spinnerTop: [], textTop: [], validate: [], ngOnDestroy: [] });
...
NgxUiLoaderBlurredDirective.ɵfac = function NgxUiLoaderBlurredDirective_Factory(t) { return new (t || NgxUiLoaderBlurredDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(NgxUiLoaderService)); };
NgxUiLoaderBlurredDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: NgxUiLoaderBlurredDirective, selectors: [["", "ngxUiLoaderBlurred", ""]], inputs: { loaderId: "loaderId", blur: "blur" } });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderBlurredDirective, [{
        type: Directive,
        args: [{ selector: '[ngxUiLoaderBlurred]' }]
    }], function () { return [{ type: ElementRef }, { type: Renderer2 }, { type: NgxUiLoaderService }]; }, { constructor: [], elementRef: [], renderer: [], loader: [], blurNumber: [], loaderId: [{
            type: Input
        }], blur: [{
            type: Input
        }], blur: [], ngOnInit: [], showForegroundWatcher: [], ngOnDestroy: [] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(NgxUiLoaderModule, { declarations: function () { return [NgxUiLoaderComponent,
        NgxUiLoaderBlurredDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [NgxUiLoaderComponent,
        NgxUiLoaderBlurredDirective]; } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderModule, [{
        type: NgModule,
        args: [{
...
NgxUiLoaderRouterModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxUiLoaderRouterModule_Factory(t) { return new (t || NgxUiLoaderRouterModule)(ɵngcc0.ɵɵinject(NgxUiLoaderRouterModule, 12), ɵngcc0.ɵɵinject(NGX_UI_LOADER_ROUTER_CONFIG_TOKEN, 8), ɵngcc0.ɵɵinject(Router), ɵngcc0.ɵɵinject(NgxUiLoaderService)); } });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderRouterModule, [{
        type: NgModule,
        args: [{}]
            ...
            }] }, { type: Router }, { type: NgxUiLoaderService }]; }, { constructor: [], exclude: [] });
...
NgxUiLoaderHttpInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgxUiLoaderHttpInterceptor, factory: function (t) { return NgxUiLoaderHttpInterceptor.ɵfac(t); }, providedIn: null });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderHttpInterceptor, [{
        type: Injectable
    }], function () { return [{ type: undefined, decorators: [{
                type: Optional
            }, {
            ...
            }] }, { type: NgxUiLoaderService }]; }, { constructor: [], loader: [], count: [], config: [], exclude: [], intercept: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgxUiLoaderHttpModule, [{
        type: NgModule,
        args: [{
                providers: [
                    {
